...
export const experienceData = [
    {
        ...
        img: <img src="nd.png" width="50px" style={{float: "right"}}/>,
        icon: <SchoolIcon />,
        description:
        ...
        keywords: ["Deep Learning", "Volume Rendering", "Multimodal Learning", "CLIP", "Diffusion Model"],
      },
    {
      ...
      },
  {
    ...
    img: <img src="vanke.png" width="50px" style={{float: "right"}}/>,
    icon: <WorkIcon />,
    ...
    keywords: ["PyTorch", "OpenCV", "Image Generation/Inpainting", "Stable Diffusion"],
  },
  {
    title: "Peer Mentor",
    ...
    date: "2020 - 2022",
    img: <img src="xidian.png" width="50px" style={{float: "right"}}/>,
    icon: <SchoolIcon />,
    description:
    ...
    keywords: ["Tutoring", "Probability Theory", "Statistics", "Advanced Mathematics"],
  },
];
